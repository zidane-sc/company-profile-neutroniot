...
<!-- Mirrored from rstheme.com/products/html/braintech/onepage2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Nov 2021 12:07:00 GMT -->
<head>
        <!-- meta tag -->
        <meta charset="utf-8">
        <title>Neutroniot</title>
                    ...
                    <div class="row">
                           ...
                           <div class="services-item">
                               <div class="services-icon">
                                   <div class="image-part">
                                       <img src="{{ asset('assets/images/services/style1/1.png') }}" alt=""> 
                                   </div>
                               </div>
                        ...
                        <div class="col-lg-3 col-md-6 md-mb-30">
                           <div class="services-item">
                               <div class="services-icon">
                                   <div class="image-part">
                                       <img src="{{ asset('assets/images/services/style1/2.png') }}" alt="">  
                                   </div>
                               </div>
                               <div class="services-content">
                                   <div class="services-text">
                        ...
                        <div class="col-lg-3 col-md-6 sm-mb-30">
                           <div class="services-item">
                               <div class="services-icon">
                                   <div class="image-part">
                                       <img src="{{ asset('assets/images/services/style1/3.png') }}" alt="">  
                                   </div>
                               </div>
                               <div class="services-content">
                                   <div class="services-text">
                        ...
                        <div class="col-lg-3 col-md-6">
                           <div class="services-item">
                               <div class="services-icon">
                                   <div class="image-part">
                                       <img src="{{ asset('assets/images/services/style1/4.png') }}" alt=""> 
                                   </div>
                               </div>
                               <div class="services-content">
                                   <div class="services-text">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6 md-mb-50">
                            <div class="images">
                               <img src="{{ asset('assets/images/about/about-2.png') }}" alt=""> 
                            </div> 
                        </div>
            ...
            <div id="rs-services" class="pt-relative rs-services style4 modify1 services3 gray-color pt-120 md-pt-80">
                ...
                <div class="bg-section pb-120 md-pb-80">
                    ...
                    <div class="shape-part">
                        <div class="left-side">
                           <img src="{{ asset('assets/images/services/shape-2.png') }}" alt=""> 
                        </div>
                        <div class="right-side">
                            <img src="{{ asset('assets/images/services/shape-3.png') }}" alt=""> 
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Mirrored from rstheme.com/products/html/braintech/onepage2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Nov 2021 12:07:38 GMT -->
</html>